...
return [
    ...
    */
    ...
    'logo' => '<b>Liste</b>',
    'logo_img' => 'https://fac.img.pmdstatic.net/fit/https.3A.2F.2Fi.2Epmdstatic.2Enet.2Ffac.2F2022.2F08.2F29.2F9fecc4ef-2adb-4778-8987-0bd19806480d.2Ejpeg/1200x900/quality/80/crop-from/center/focus-point/1016%2C797/4-sites-pour-trouver-une-femme-de-menage.jpeg',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'    => 'Femmes de menage',
            'icon'    => 'fas fa-fw fa-arrow-alt-circle-right',
            'submenu' => [
                [
                    'text' => 'Liste des femmes de menage',
                    'url'  => 'admin/femmes',
                    'icon' => 'fas fa-fw fa-list'
                ],
                [
                    'text' => 'create',
                    'url'  => 'admin/femmes/create',
